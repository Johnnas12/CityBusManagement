...
@section('main-content')
    <div class="container ">
        <div class="card shadow-lg">
            <div id="panel-2" class="panel p-4">
                <div class="panel-hdr">
                    <h5 class="text-center">
                        Spare Parts <span class="fw-300"><i>Registration Form</i></span>
                    </h5>
                    <hr>
                </div>
                <div class="panel-container show">
                    <div class="panel-content p-0">
                        ...
                        <div class="panel-content">
                            ...
                            <form class="needs-validation" novalidate action="{{ route('storekeeper.storespares') }}"
