...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('assets/css/main.d810cf0ae7f39f28f336.css')}}">
...
" rel="stylesheet">
  ...
  <body>
                  ...
                  <div class="dropdown-menu-header">
                    <div class="dropdown-menu-header-inner bg-success">
                      <div
                        ...
                        style="
                          background-image: url({{asset('assets/images/dropdown-header/abstract3.jpg')}});
                        "
                      ></div>
    ...
    <script
      ...
      src="{{asset('assets/scripts/main.d810cf0ae7f39f28f336.js')}}"
